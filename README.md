...
:root {
  ...
  --black-hole: url(https://images6.alphacoders.com/638/638225.jpg);
...
.platform-linux #app-mount .applicationStore-1pNvnv,
.platform-linux #app-mount .pageWrapper-1PgVDX,
...
.scrollableContainer-2NUZem .inner-MADQqc{
  margin-bottom: 0px;
}
...
#app-mount .isUnread-3Ef-o9 .divider-JfaTT5 span {
  color: var(--dnd-sheer);
}

#app-mount .divider-3gKybi:not(.isUnread-3Ef-o9) .divider-JfaTT5 span:after {
  border-image: linear-gradient(to right, var(--greyple-sheer) 50%, transparent);
  border-image-slice: 1;
}

#app-mount .divider-JfaTT5.isUnread-3Ef-o9 .unreadPillCap-3_K2q2 {
  display: none;
}
...
#app-mount .divider-JfaTT5.isUnread-3Ef-o9.hasContent-1cNJDh .content-1o0f9g {
  margin-left: 30px;
}

#app-mount .divider-JfaTT5.isUnread-3Ef-o9.hasContent-1cNJDh .content-1o0f9g::before {
  content: " | ";
  margin-right: 10px;
}

#app-mount .divider-JfaTT5.isUnread-3Ef-o9 span {
  color: var(--dnd);
}

#app-mount .divider-JfaTT5:after {
  content: "";
  position: relative;
  flex: 1 0 auto;
  margin-left: 5px;
...
#app-mount .divider-JfaTT5.isUnread-3Ef-o9:after {
  margin-left: 30px;
  background: linear-gradient(to right, var(--dnd-sheer) 50%, transparent);
}

#app-mount .divider-JfaTT5.isUnread-3Ef-o9.hasContent-1cNJDh:after {
  margin-left: 5px;
}
...
#app-mount .membersWrap-2h-GB4::after {
  content: '';
  position: absolute;
  bottom: 0;
  height: 55px;
...
.placeholderUsername-2B_OA9 {
  background-color: var(--blurple-sheet);
}
...
.popoutBottom-1YbShG[style*="overflow: hidden; visibility: visible;"][role*="dialog"] {
  ...
  /* B. User Status */
  .layer-v9HyYc[style*="; bottom: 5"][id*="popout_"] {
...
.layer-v9HyYc[style*="; bottom: 5"][id*="popout_"] .menu-3sdvDG .item-1tOPte:not(:nth-child(7)) * {
  display: none;
}
...
.layer-v9HyYc[style*="; bottom: 5"][id*="popout_"] .menu-3sdvDG .item-1tOPte:nth-child(1) {
...
.layer-v9HyYc[style*="; bottom: 5"][id*="popout_"] .menu-3sdvDG .item-1GzJrl:nth-child(7) .customStatusContentIcon-2sionu {
  height: 100%;
  width: 100%;
  display: flex;
  flex-flow: row wrap;
...
.layer-v9HyYc[style*="; bottom: 5"][id*="popout_"] .menu-3sdvDG .item-1tOPte:last-child:nth-child(7) {
  background: var(--quatro)  var(--stars) top left;
  background-attachment: fixed;
  display: flex;
  flex-flow: row wrap;
...
.layer-v9HyYc[style*="; bottom: 5"][id*="popout_"] .menu-3sdvDG .item-1tOPte:not(:nth-child(7)):hover {
  transform: scale(1.3);
}
...
#app-mount .channelSeparator-1DOiGt .channelName-1JRO3C {
  background-color: var(--sheer);
  padding-left: 8px;
  border-radius: 5px 5px 0 0;
}

#app-mount .searchResult-9tQ1uo:before {
  background-image: linear-gradient(0deg,transparent,var(--sheer));
}

#app-mount .searchResult-9tQ1uo .searchResultMessage-1fxgXh.hit-1fVM9e {
  background: var(--sheer);
...
#app-mount .searchResult-9tQ1uo:after {
  background: linear-gradient(180deg,transparent,var(--sheer));
}
...
#app-mount .channelContainer-1x3D6I,
...
.header-QKLPzZ .wrapper-3t9DeA.avatar-3EQepX::before {
  content:'';
  position:absolute;
  ...
  height: 300px; /*Height of modal header*/
  opacity:.5;
  pointer-events:none;
